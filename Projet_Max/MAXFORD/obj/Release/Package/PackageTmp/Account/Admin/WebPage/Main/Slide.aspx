<%@ Page Title="" Language="C#" MasterPageFile="~/Account/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Slide.aspx.cs" Inherits="MAXFORD.Account.Admin.WebPage.Main.Slide" %>
            ...
            <asp:GridView 
                ...
                <Columns>
	                ...
	                <asp:ImageField HeaderText="Preview" DataImageUrlField="PageMainImageThumbnail" DataImageUrlFormatString="~/Store/Slide/thumbnail/{0}"
	                    DataAlternateTextField="MainID" DataAlternateTextFormatString="Record #{0}">
