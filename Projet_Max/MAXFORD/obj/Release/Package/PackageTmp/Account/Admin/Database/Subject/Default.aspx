<%@ Page Title="" Language="C#" MasterPageFile="~/Account/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="MAXFORD.Account.Admin.Database.Subject.Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Body" runat="server">
    <div class="container">
            ...
            <span class="sticky">
                <div class="max_middle_nav_bar">
                    <ul>
                        ...
                        <li><a id="A3" runat="server" href="~/Account/Admin/Database/Subject/Default.aspx" >VIEW </a></li>
                    </ul>
                </div>
            </span>
        </div>
        ...
        <div class="pageContainer">
            <div style="border:solid 2px #099999; padding:15px;">
                ...
                <asp:GridView 
                    ...
                    >
                    <Columns>
	                    <asp:BoundField HeaderText="Subject ID" DataField="SubjectID" ReadOnly="True" SortExpression="SubjectID" >
	                    ...
	                    <asp:BoundField HeaderText="Subject Title" DataField="SubjectTitle" SortExpression="SubjectTitle" ReadOnly="True" >
		                    <ItemStyle HorizontalAlign="Left" VerticalAlign="Middle" />
	                    </asp:BoundField>
    	            
	                    <asp:ImageField HeaderText="Preview" DataImageUrlField="SubjectImageThumbnail" DataImageUrlFormatString="~/Store/Subject/thumbnail/{0}"
	                        DataAlternateTextField="SubjectID" DataAlternateTextFormatString="Record #{0}">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ...
            SelectCommand="SELECT * FROM dbo.ClassSubject"
            DeleteCommand="DELETE FROM dbo.ClassSubject WHERE SubjectID = @SubjectID" 
            OnDeleting="AccessDataSource1_Deleting" >
            <DeleteParameters>
	            <asp:ControlParameter ControlID="GridView1" Name="SubjectID" PropertyName="SelectedValue" Type="Int32" />
            </DeleteParameters>
        </asp:SqlDataSource>
