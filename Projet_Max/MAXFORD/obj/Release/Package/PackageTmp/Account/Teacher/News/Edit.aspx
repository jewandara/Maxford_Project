<%@ Page Title="" Language="C#" MasterPageFile="~/Account/Teacher/Teacher.Master" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="MAXFORD.Account.Teacher.News.Edit" %>
        ...
        <asp:UpdatePanel runat="server" ID="UpdatePanel1">
            <ContentTemplate>        
                <table border="0" style="width:100%;">
                    <tr>
                        <td style="width:150px;padding:5px;vertical-align: text-top;"><strong>News ID : <br /></strong></td>
                    ...
                    <tr>
                        <td style="padding:5px;vertical-align: text-top;"><strong>NewsName :<br /></strong></td>
                        <td style="padding:5px;"><asp:TextBox runat="server" ID="NewsName" Width="100%" MaxLength="50"></asp:TextBox></td>
                        <td style="padding:5px; color:red"><asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator0" ControlToValidate="NewsName" ErrorMessage="* Required field"></asp:RequiredFieldValidator></td>
                    </tr>
                    <tr>
                        <td style="padding:5px;vertical-align: text-top;"><strong>News View : <br /></strong></td>
                        <td style="padding:5px;"><CommonUC:SimpleImageUpload runat="server" ID="Picture1"  Width="100%" /></td>
                        <td style="padding:5px; color:red"></td>
                    </tr>
                    <tr>
                        <td style="padding:5px;vertical-align: text-top;"><strong>News Body : <br /></strong></td>
                        <td style="padding:5px;"><CKEditor:CKEditorControl ID="NewsBody" Width="100%" Height="500px" BasePath="~/Store/ckeditor/" runat="server"></CKEditor:CKEditorControl></td>
