<%@ Page Title="" Language="C#" MasterPageFile="~/Account/Teacher/Teacher.Master" AutoEventWireup="true" CodeBehind="Image.aspx.cs" Inherits="MAXFORD.Account.Teacher.Profile.Image" %>
            ...
            <div style="border:solid 2px #099999; padding:15px;"> 
                <div class="max_middle_nav_bar">
                    <ul style="text-align:center">
                        ...
                        <li><a id="A4" runat="server" href="~/Account/Teacher/Profile/Image.aspx" > IMAGE </a></li>
                    </ul>
                </div>
				<div class="box">
                        ...
                        <ContentTemplate>
                            <div>
                                <table border="0" style="width:100%;">
                                    <tr>
                                        <td style="padding:5px;vertical-align: text-top;"><strong>View : <br /></strong></td>
