<%@ Page Title="" Language="C#" MasterPageFile="~/Account/Teacher/Teacher.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="MAXFORD.Account.Teacher.Event.Default" %>
    ...
    <div class="container" style="margin-top:-25px;">
        ...
        <div class="pageContainer">
            ...
            <asp:GridView 
                ...
                >
                <Columns>
	                <asp:BoundField HeaderText="Event ID" DataField="EventID" ReadOnly="True" SortExpression="EventID" Visible="false" >
		                <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" Width="100px" />
	                </asp:BoundField>

	                <asp:BoundField HeaderText="Event Name" DataField="EventName" SortExpression="EventName" ReadOnly="True" >
		                <ItemStyle HorizontalAlign="Left" VerticalAlign="Middle" />
	                </asp:BoundField>
    	            
	                <asp:BoundField HeaderText="Catogory" DataField="CatName" SortExpression="CatName" ReadOnly="True" >
