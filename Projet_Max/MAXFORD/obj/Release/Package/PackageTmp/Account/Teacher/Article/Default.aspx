<%@ Page Title="" Language="C#" MasterPageFile="~/Account/Teacher/Teacher.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="MAXFORD.Account.Teacher.Article.Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Body" runat="server">
    <div class="container" style="margin-top:-25px;">
        ...
        <div class="pageContainer">
            ...
            <br />
            <asp:Button runat="server" ID="btnAddNew" Text="ADD NEW ARTICLE" CausesValidation="false" OnClick="btnAddNew_Click" />
            <asp:Button runat="server" ID="btnAddNewTwo" Text="ADD NEW ARTICLE" CausesValidation="false" OnClick="btnAddNew_Click" CssClass="RightButton"/>
        </div>
    </div> 
