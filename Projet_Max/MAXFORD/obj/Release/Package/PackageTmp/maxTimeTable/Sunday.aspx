<%@ Page Title="Maxford Sunday TimeTable" Language="C#" MasterPageFile="~/maxTimeTable/TimeTable.Master" AutoEventWireup="true" CodeBehind="Sunday.aspx.cs" Inherits="MAXFORD.maxTimeTable.Sunday" %>
...
<h1>Time Table [ SUNDAY ]</h1>
<p>This is Sunday Maxford Class Time Table.</p>
</asp:Content>
...
<table class="tt_timetable" style="background-color: #F0F0F0; border:1px solid #033;  border-top:7px solid #033;">
    <thead>
        <tr>
	        ...
	        <th><a href="Sunday.aspx" class="max_row_date max_row_date_active" >Sunday</a></th>	
        </tr>
    </thead>
<tbody>
