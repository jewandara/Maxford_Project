<%@ Page Title="Maxford Wednesday TimeTable" Language="C#" MasterPageFile="~/maxTimeTable/TimeTable.Master" AutoEventWireup="true" CodeBehind="Wednesday.aspx.cs" Inherits="MAXFORD.maxTimeTable.Wednesday" %>
...
<h1>Time Table [ WEDNESDAY ]</h1>
<p>This is Wednesday Maxford Class Time Table.</p>
</asp:Content>
...
<table class="tt_timetable" style="background-color: #F0F0F0; border:1px solid #033;  border-top:7px solid #033;">
    <thead>
        <tr>
	        ...
	        <th><a href="Wednesday.aspx" class="max_row_date max_row_date_active" >Wednesday</a></th>	
