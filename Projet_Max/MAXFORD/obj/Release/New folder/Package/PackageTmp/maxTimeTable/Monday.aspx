<%@ Page Title="Maxford Monday TimeTable" Language="C#" MasterPageFile="~/maxTimeTable/TimeTable.Master" AutoEventWireup="true" CodeBehind="Monday.aspx.cs" Inherits="MAXFORD.maxTimeTable.Monday" %>
...
<h1>Time Table [ MONDAY ]</h1>
<p>This is Monday Maxford Class Time Table.</p>
</asp:Content>
...
<table class="tt_timetable" style="background-color: #F0F0F0; border:1px solid #033;  border-top:7px solid #033;">
    <thead>
        <tr>
	        <th></th>	
	        <th><a href="Monday.aspx" class="max_row_date max_row_date_active" >Monday</a></th>	
