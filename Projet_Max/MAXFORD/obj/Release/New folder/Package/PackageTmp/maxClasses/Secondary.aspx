<%@ Page Title="" Language="C#" MasterPageFile="~/maxClasses/Classes.Master" AutoEventWireup="true" CodeBehind="Secondary.aspx.cs" Inherits="MAXFORD.maxClasses.Secondary" %>
    ...
    <div class="maxTeacherProfileBody">
        <div class="SideNavMenuBar">
            <ul class="SideNavMenuItems">
                ...
                <li><a href="Secondary.aspx" style="text-decoration:none;background:#088;color:#fff;"> SECONDARY </a></li>
            ...
            <div style="text-decoration:none;background:#088;color:#fff; display:block; margin-top:-10px; padding-top:30px; padding-left:5px; padding-bottom:25px;">
                <tr>                   
                    <td valign="top">
                        <h5 style="color:#fff; padding-left:20px;">Details of the Secondary Level Classes in Maxford Higher Educational Institute</h5>
                    </td>
                </tr>
            </div>
                    ...
                    <td valign="top">
                        ...
                        <asp:Panel ID="PanelCatogory" runat="server">
                            ...
                            <asp:SqlDataSource 
                                    ...
                                    SelectCommand="SELECT * FROM [vw_maxford_Classes] WHERE GradeCatogory = 'SECONDARY' AND GradeID = @GradeID">
                        ...
                        <h3 style="font-size:15px; font-weight:bold;">
                            <asp:Label ID="LabelOther" runat="server" Text="Secondary Level Classes"></asp:Label>
                        </h3><hr />
                        ...
                        <asp:Panel ID="PanelCode" runat="server" Enabled="false">
                            ...
                            <asp:SqlDataSource 
                                    ...
                                    runat="server"
                                    ConnectionString="<%$ ConnectionStrings:DefaultConnection %>"
                                    SelectCommand="SELECT TOP 10 * FROM [vw_maxford_Classes] WHERE GradeCatogory = 'SECONDARY'">
                            </asp:SqlDataSource>
                        </asp:Panel>
