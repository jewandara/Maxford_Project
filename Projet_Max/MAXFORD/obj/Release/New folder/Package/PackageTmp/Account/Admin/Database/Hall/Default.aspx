<%@ Page Title="" Language="C#" MasterPageFile="~/Account/Admin/Admin.Master" AutoEventWireup="True" CodeBehind="Default.aspx.cs" Inherits="MAXFORD.Account.Admin.Database.Hall.Default" %>
            ...
            <span class="sticky">
                <div class="max_middle_nav_bar">
                    <ul>
                        ...
                        <li><a runat="server" href="~/Account/Admin/Database/Hall/Default.aspx" >VIEW </a></li>
                    </ul>
                </div>
            </span>
        </div>
