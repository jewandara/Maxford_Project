<%@ Page Title="" Language="C#" MasterPageFile="~/Account/Teacher/Teacher.Master" AutoEventWireup="true" CodeBehind="Password.aspx.cs" Inherits="MAXFORD.Account.Teacher.Profile.Password" %>
            ...
            <div style="border:solid 2px #099999; padding:15px;">
                ...
                <div class="max_middle_nav_bar">
                    <ul style="text-align:center">
                        ...
                        <li><a id="A4" runat="server" href="~/Account/Teacher/Profile/Password.aspx" > PASSWORD </a></li>
                    </ul>
                </div>
