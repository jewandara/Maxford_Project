<%@ Page Title="" Language="C#" MasterPageFile="~/Account/Admin/Admin.Master" AutoEventWireup="True" CodeBehind="Default.aspx.cs" Inherits="MAXFORD.Account.Admin.Database.Grade.Default" %>
        ...
        <div class="row">                       
            <span class="sticky">
                <div class="max_middle_nav_bar">
                    <ul>
                        <li><a runat="server" href="~/Account/Admin/Manage.aspx" >HOME </a></li> >
                        <li><a runat="server" href="~/Account/Admin/Database/Default.aspx" >CLASS </a></li> >
                        <li><a runat="server" href="~/Account/Admin/Database/Grade/Default.aspx" >VIEW </a></li>
                    </ul>
                </div>
            </span>
        </div>
