<%@ Page Title="" Language="C#" MasterPageFile="~/maxTeacher/Teacher.Master" AutoEventWireup="true" CodeBehind="teacher.aspx.cs" Inherits="MAXFORD.maxTeacher.teacher" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolderTeacherBodyDetails" runat="server">
    ...
    <br /><br />
    <asp:Label ID="maxLabelAboutTeacher" runat="server" Text="Label"></asp:Label>
</asp:Content>