<%@ Page Title="" Language="C#" MasterPageFile="~/maxClasses/Classes.Master" AutoEventWireup="true" CodeBehind="Ordinary.aspx.cs" Inherits="MAXFORD.maxClasses.Ordinary" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="TopContent" runat="server">
	<div class="maxTeacherHeaderWrap">
        <table class="maxTeacherHeaderWrapTable">
            <tr align="left">
                <td><h4 style="font-size:25px; color:#fff; ">Ordinary Level Classes</h4>
    ...
    <div class="maxTeacherProfileBody">
        <div class="SideNavMenuBar">
            <ul class="SideNavMenuItems">
                ...
                <li><a href="Ordinary.aspx" style="text-decoration:none;background:#088;color:#fff;"> ORDINARY </a></li>
                    ...
                    <td valign="top">
                        ...
                        <asp:Panel ID="PanelCatogory" runat="server">
                            ...
                            <asp:SqlDataSource 
                                    ...
                                    SelectCommand="SELECT * FROM [vw_maxford_Classes] WHERE GradeCatogory = 'ORDINARY' AND GradeID = @GradeID">
                        ...
                        <h3 style="font-size:15px; font-weight:bold;">
                            <asp:Label ID="LabelOther" runat="server" Text="Ordunary Level Classes"></asp:Label>
                        </h3><hr />
                        ...
                        <asp:Panel ID="PanelCode" runat="server" Enabled="false">
                            ...
                            <asp:SqlDataSource 
                                    ...
                                    runat="server"
                                    ConnectionString="<%$ ConnectionStrings:DefaultConnection %>"
                                    SelectCommand="SELECT TOP 10 * FROM [vw_maxford_Classes] WHERE GradeCatogory = 'ORDINARY'">
                            </asp:SqlDataSource>
                        </asp:Panel>
