                ...
                using (SqlCommand command = connection.CreateCommand())
                {
                    ...
                    using (SqlDataReader Reader = command.ExecuteReader())
                    {
                        ...
                        while (Reader.Read())
                        {
                            ...
                            {
                                htmlCodeBody = htmlCodeBody + "<li><a href='Primary.aspx?GradeID=" + Reader["GradeId"].ToString() + "' style='text-decoration:none;background:#366;color:#fff;'>" + Reader["GradeName"].ToString() + " &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src='images/point.png' style=' margin-bottom:10px; width:11px;'/></a></li>";
                            }
                            else
                            {
                                htmlCodeBody = htmlCodeBody + "<li><a href='Primary.aspx?GradeID=" + Reader["GradeId"].ToString() + "'>" + Reader["GradeName"].ToString() + " &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a></li>";
                            }
                        }
                        connection.Close();
                    }
