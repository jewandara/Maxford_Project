...
namespace MAXFORD.Account.Teacher.News
{
    public partial class Default : System.Web.UI.Page
    {
        ...
        protected void Display()
        {
            ...
            SqlDataSource1.SelectCommand = "SELECT NewsID, NewsName, NewsImageThumbnail FROM dbo.vw_maxford_News WHERE UserName = '" + UserName + "'";
        ...
        {
            Response.Redirect("Edit.aspx?NewsID=" + id, true);
        }
        ...
        protected void AccessDataSource1_Deleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            Response.Redirect("Delete.aspx?NewsID=" + id, true);
        }
