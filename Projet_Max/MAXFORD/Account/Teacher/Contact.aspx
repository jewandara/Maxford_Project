<%@ Page Title="" Language="C#" MasterPageFile="~/Account/Teacher/Teacher.Master" AutoEventWireup="true" CodeBehind="Contact.aspx.cs" Inherits="MAXFORD.Account.Teacher.Contact" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Body" runat="server">
    <div class="container">
        ...
        <div class="mbr-header mbr-header--center mbr-header--std-padding">
            ...
            <asp:Panel ID="Errorss" runat="server" Visible ="false">
        ...
        <h2> Maxford Contact Administrator</h2>
