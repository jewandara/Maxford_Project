...
namespace MAXFORD.Account.Teacher.Event
{
    public partial class Default : System.Web.UI.Page
    {
        ...
        protected void Display()
        {
            ...
            SqlDataSource1.SelectCommand = "SELECT EventID, EventName, CatName FROM dbo.vw_maxford_Event WHERE UserName = '" + UserName + "'";
        ...
        {
            Response.Redirect("Edit.aspx?EventID=" + id, true);
        }
        ...
        protected void AccessDataSource1_Deleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            Response.Redirect("Delete.aspx?EventID=" + id, true);
        }
