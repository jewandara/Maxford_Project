    ...
    public partial class Footer : System.Web.UI.Page
    {
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            using (SqlConnection connection = ExamplesHelper.GetNewOpenDbConnection_SqlServer())
            {
                ...
                {
                    command.CommandType = CommandType.Text;
                    command.CommandText = "UPDATE dbo.PageMain SET PageMainTitle=@PageMainTitle,PageMainBody=@PageMainBody,ModifiedDate=GETDATE() WHERE PageDataCatogory = 'MAIN_FOOTER'";
