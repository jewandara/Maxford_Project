<%@ Page Title="" Language="C#" MasterPageFile="~/Account/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Event.aspx.cs" Inherits="MAXFORD.Account.Admin.WebPage.Main.Event" %>
    ...
    <div class="container" style="margin-top:-25px;">
        <div class="thumbnail">
            <p class="group">
                ...
                <a id="A2" runat="server" href="~/Account/Admin/WebPage/Main/Event.aspx" class="btn btn-default" style="width:200px; background:#000; border-color:#000; color:#fff;">EVENTS</a>
