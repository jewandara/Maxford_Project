<%@ Page Title="" Language="C#" MasterPageFile="~/Account/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="MAXFORD.Account.Admin.Debates.Event.Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Body" runat="server">
    <div class="container" style="margin-top:-25px;">
            ...
            <style type="text/css">
                ...
                <asp:GridView 
                    ...
                    <Columns>
	                    ...
	                    <asp:BoundField HeaderText="Debate Date" DataField="DebateDate" SortExpression="DebateDate" ReadOnly="True" >
	                    ...
	                    <asp:CommandField ShowCancelButton="False" ShowDeleteButton="True" ShowEditButton="True" ButtonType="Button" EditText="EDIT EVENTS" DeleteText="DELETE EVENTS">
		                    <ItemStyle Width="170px" HorizontalAlign="Left" VerticalAlign="Middle" />
	                    </asp:CommandField>
                    </Columns>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ...
            SelectCommand="SELECT * FROM dbo.Debate" >
        </asp:SqlDataSource>
