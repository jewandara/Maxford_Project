...
{
    public partial class Monday : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            while (maxTime <= 12)
            {
                ...
                dataTable = dataTable + AddClass(maxTime.ToString() + ":00", "Monday") + "</tr>";

                dataTable = dataTable + "<tr class='row_1 row_gray'><td class='tt_hours_column'>" + maxTime + ":30 AM</td>";
                dataTable = dataTable + AddClass(maxTime.ToString() + ":30", "Monday") + "</tr>";
