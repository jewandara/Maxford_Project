...
namespace maxACCOUNT.Teacher.web
{
    public partial class Profile : System.Web.UI.Page
    {
        ...
        public void Display()
        {
            ...
            SqlCommand cmd = new SqlCommand("SELECT * FROM vw_aspnet_UsersData WHERE (UserName = '" + UserName + "')", new SqlConnection(System.Web.Configuration.WebConfigurationManager.ConnectionStrings["ZionxMaxUserDB"].ConnectionString));
            cmd.Connection.Open();
        ...
        protected void SaveBoxOne_Click(object sender, EventArgs e)
        {
            ...
            {
                UserName = System.Web.HttpContext.Current.User.Identity.Name;
                SqlCommand cmd = new SqlCommand("UPDATE dbo.aspnet_UsersData SET Title = @Title, DateOfBirth = @DateOfBirth, Gender = @Gender, Merried = @Merried  WHERE (UserId = (SELECT UserId FROM dbo.aspnet_Users WHERE (UserName = @UserName)))", new SqlConnection(System.Web.Configuration.WebConfigurationManager.ConnectionStrings["ZionxMaxUserDB"].ConnectionString));
                cmd.Connection.Open();
        ...
        protected void SaveBoxTwo_Click(object sender, EventArgs e)
        {
            ...
            {
                UserName = System.Web.HttpContext.Current.User.Identity.Name;
                SqlCommand cmd = new SqlCommand("UPDATE dbo.aspnet_UsersData SET UserFirstName = @UserFirstName, UserMiddleName = @UserMiddleName, UserLastName = @UserLastName, UserSurname = @UserSurname, UserInitialName = @UserInitialName WHERE (UserId = (SELECT UserId FROM dbo.aspnet_Users WHERE (UserName = @UserName)))", new SqlConnection(System.Web.Configuration.WebConfigurationManager.ConnectionStrings["ZionxMaxUserDB"].ConnectionString));
                cmd.Connection.Open();
        ...
        protected void SaveBoxFour_Click(object sender, EventArgs e)
        {
            ...
            {
                UserName = System.Web.HttpContext.Current.User.Identity.Name;
                SqlCommand cmd = new SqlCommand("UPDATE dbo.aspnet_UsersData SET PersonalEmail = @PersonalEmail, OfficealEmail = @OfficealEmail, TelePhone = @TelePhone, HandPhone = @HandPhone, ContactNo = @ContactNo, FaxNumber = @FaxNumber WHERE (UserId = (SELECT UserId FROM dbo.aspnet_Users WHERE (UserName = @UserName)))", new SqlConnection(System.Web.Configuration.WebConfigurationManager.ConnectionStrings["ZionxMaxUserDB"].ConnectionString));
                cmd.Connection.Open();
        ...
        protected void SaveBoxFive_Click(object sender, EventArgs e)
        {
            ...
            {
                UserName = System.Web.HttpContext.Current.User.Identity.Name;
                SqlCommand cmd = new SqlCommand("UPDATE dbo.aspnet_UsersData SET NICNumber = @NICNumber, DriverLicen = @DriverLicen WHERE (UserId = (SELECT UserId FROM dbo.aspnet_Users WHERE (UserName = @UserName)))", new SqlConnection(System.Web.Configuration.WebConfigurationManager.ConnectionStrings["ZionxMaxUserDB"].ConnectionString));
                cmd.Connection.Open();
