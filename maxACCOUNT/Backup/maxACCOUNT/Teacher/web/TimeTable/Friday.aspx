<%@ Page Title="" Language="C#" MasterPageFile="~/Teacher/Teacher.Master" AutoEventWireup="true" CodeBehind="Friday.aspx.cs" Inherits="maxACCOUNT.Teacher.web.TimeTable.Friday" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolderTeacherBody" runat="server">
			...
			<div>
				<ul class="breadcrumb">
                    ...
                    <li><a href="Friday.aspx">FRIDAY</a> </li>
				</ul>
			</div>
