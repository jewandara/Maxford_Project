...
namespace MAXFORD.Max_Account.MaxfordUser.Administrator
{
    public partial class maxMenuSide : System.Web.UI.UserControl
    {
        ...
        //        {
        //            AccessCode = AccessCode + "<li><div class='max_side_menu_bar maxIconDashboard'><a href='/Max_Account/MaxfordUser/Administrator/max" + dr["MENU_DATA"].ToString() + "/Default.aspx' >" + dr["MENU_DATA"].ToString() + "</a></div></li>";
        //        }
