<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="maxACCOUNT.Admin.web.STUDENTS.Default" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHoldermaxTopMenuBar" runat="server">
    <div style="margin-left:12px;">
        <li><asp:Button ID="Button1" runat="server" Text="VIEW TEACHERS" onclick="Button1_Click" CssClass='max_main_SUB_MENU_STYLE' /></li>
        <li><asp:Button ID="Button2" runat="server" Text="NEW TEACHERS" onclick="Button2_Click" CssClass='max_main_SUB_MENU_STYLE' /></li>
    </div>
</asp:Content>
						...
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  ...
						  <tbody>
                            ...
                            <asp:SqlDataSource ID="BaseSqlDataSource" runat="server" 
                                ...
                                SelectCommand="SELECT * FROM [MAX_SYS_BASE]">
                            </asp:SqlDataSource>
						  </tbody>
					  </table>            
					</div>
