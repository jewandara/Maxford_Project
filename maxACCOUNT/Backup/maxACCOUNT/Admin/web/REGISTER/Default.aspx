<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="maxACCOUNT.Admin.web.REGISTER.Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderAdminMenu" runat="server">
                    ...
                    <li><div class="max_side_menu_bar maxIconTecherRegister maxIconTecherActive"><a href="Default.aspx">REGISTER</a></div></li>
