<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="maxACCOUNT.Admin.web.SUBJECTS.Default" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="ContentPlaceHolderAdminMenu" runat="server">
                    ...
                    <li><div class="max_side_menu_bar maxIconTecherSubjects maxIconTecherActive"><a href="Default.aspx">SUBJECTS</a></div></li>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderBodyHead" runat="server">
	<div>
        <br /><h4>Maxford SUBJECTS Details</h4><br />
		<ul class="breadcrumb">
			<li><a href="../../Default.aspx">ACCOUNT</a> <span class="divider">/</span></li>
			<li><a href="Default.aspx">SUBJECTS</a></li>
		</ul>
	</div>
</asp:Content>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolderBody" runat="server">
			...
			<div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2> MAXFORD SUBJECTS FOR PRIMARY</h2>
					</div>
					<div class="box-content">
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  ...
						  <tbody>
                            <asp:Repeater ID="Repeater1" runat="server" DataSourceID="SubjectSqlDataSourcePRIMARY">
                                <ItemTemplate>
							        <tr>
								        <td><%# Eval("SubjectName")%></td>
								        <td class="center"><%# Eval("SubjectCatogory")%></td>
								        <td class="center"><%# Eval("SubjectTitle")%></td>
								        <td class="center"><span class="label label-success"><%# Eval("Activiated")%></span></td>
                                        <td class="center"><%# Eval("ModifiedDate")%></td>
								        <td class="center">
									        <a class="btn btn-info" href='Edit.aspx?SubjectId=<%# Eval("SubjectId")%>'>
										        <i class="icon-edit icon-white"></i>  
										        Edit                                            
									        </a>
									        <a class="btn btn-danger" href='Delete.aspx?SubjectId=<%# Eval("SubjectId")%>'>
                            ...
                            <asp:SqlDataSource ID="SubjectSqlDataSourcePRIMARY" runat="server" 
                                ConnectionString="<%$ ConnectionStrings:ZionxMaxUserDB %>" 
                                SelectCommand="SELECT * FROM [aspnet_ClassSubject] WHERE SubjectCode = 'PRIMARY'">
                            </asp:SqlDataSource>
						  </tbody>
					  </table>            
					</div>
    ...
    <asp:Panel ID="Panel2" runat="server">
			<div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2> MAXFORD SUBJECTS FOR SECONDARY</h2>
					</div>
					<div class="box-content">
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  <thead>
						  ...
						  <tbody>
                            <asp:Repeater ID="Repeater2" runat="server" DataSourceID="SubjectSqlDataSourceSECONDARY">
                                <ItemTemplate>
							        <tr>
								        <td><%# Eval("SubjectName")%></td>
								        <td class="center"><%# Eval("SubjectCatogory")%></td>
                            ...
                            <asp:SqlDataSource ID="SubjectSqlDataSourceSECONDARY" runat="server" 
                                ConnectionString="<%$ ConnectionStrings:ZionxMaxUserDB %>" 
                                SelectCommand="SELECT * FROM [aspnet_ClassSubject] WHERE SubjectCode = 'SECONDARY'">
                            </asp:SqlDataSource>
						  </tbody>
					  </table>            
					</div>
    ...
    <asp:Panel ID="Panel3" runat="server">
			<div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2> MAXFORD SUBJECTS FOR ORDINARY</h2>
					</div>
					<div class="box-content">
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  <thead>
						  ...
						  <tbody>
                            <asp:Repeater ID="Repeater3" runat="server" DataSourceID="SubjectSqlDataSourceORDINARY">
                                <ItemTemplate>
							        <tr>
								        <td><%# Eval("SubjectName")%></td>
								        <td class="center"><%# Eval("SubjectCatogory")%></td>
                            ...
                            <asp:SqlDataSource ID="SubjectSqlDataSourceORDINARY" runat="server" 
                                ConnectionString="<%$ ConnectionStrings:ZionxMaxUserDB %>" 
                                SelectCommand="SELECT * FROM [aspnet_ClassSubject] WHERE SubjectCode = 'ORDINARY'">
                            </asp:SqlDataSource>
						  </tbody>
					  </table>            
					</div>
    ...
    <asp:Panel ID="Panel4" runat="server">
			<div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2> MAXFORD SUBJECTS FOR ADVANCED</h2>
					</div>
					<div class="box-content">
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  <thead>
						  ...
						  <tbody>
                            <asp:Repeater ID="Repeater4" runat="server" DataSourceID="SubjectSqlDataSourceADVANCED">
                                <ItemTemplate>
							        <tr>
								        <td><%# Eval("SubjectName")%></td>
								        <td class="center"><%# Eval("SubjectCatogory")%></td>
                            ...
                            <asp:SqlDataSource ID="SubjectSqlDataSourceADVANCED" runat="server" 
                                ConnectionString="<%$ ConnectionStrings:ZionxMaxUserDB %>" 
                                SelectCommand="SELECT * FROM [aspnet_ClassSubject] WHERE SubjectCode = 'ADVANCED'">
                            </asp:SqlDataSource>
						  </tbody>
					  </table>            
					</div>
