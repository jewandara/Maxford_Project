<%@ Page Title="" validateRequest="false" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="maxACCOUNT.Admin.web.EVENTS.Edit" %>
		...
		<div class="row-fluid sortable">
			<div class="box span12">
				<div class="box-header well" data-original-title>
					<h2><i class="icon-edit"></i> Maxford Event - Edit Event</h2>
				</div>
					...
					<form class="form-horizontal">
                        ...
                        <table style=" display:block; border: 1px solid #DEDEDE; border-radius:5px; padding:15px;">
                            ...
                            <tr>
                                ...
                                <td align="left" valign="top"><asp:TextBox ID="maxEventTitleTextBox" runat="server" Width="100%"></asp:TextBox></td>
                                <td align="right" valign="top"></td>
                                <td align="left"></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td align="right" valign="top"><label class="control-label" for="typeahead">Event Sub</label></td>
                                <td align="right" valign="top"></td>
                                <td align="left" valign="top"><asp:TextBox ID="maxEventSubTextBox" runat="server" Width="100%" TextMode="MultiLine"></asp:TextBox></td>
                                <td align="right" valign="top"></td>
                                <td align="left"></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td valign="top">Event Body</td>
                                <td valign="top"></td>
                                <td valign="top"><asp:TextBox ID="maxEventBodyeditor" runat="server" TextMode="MultiLine" class="ckeditor" ></asp:TextBox></td>
                            ...
                            <tr>
                                ...
                                <td valign="top"></td>
                                <td valign="top"><asp:TextBox ID="maxEventDiscripitionTextBox" runat="server" CssClass="maxTextBox" Height="50" TextMode="MultiLine"></asp:TextBox></td>
                                <td valign="top"></td>
                                <td valign="top"></td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td></td>
                                <td>
                                    <asp:Button ID="maxEventEditButton" runat="server" Text="SAVE EVENT"  CssClass="maxButton btn btn-success" Width="100%" OnClick="maxEventSave_Click" />
                                    <br /><br /><hr /><br />
                                </td>
                                <td></td>
                                <td></td>
