<%@ Page Title="" Language="C#" validateRequest="false"  MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="NEW_SAVE.aspx.cs" Inherits="maxACCOUNT.Admin.web.SLIDES.NEW_SAVE" %>
					...
					<form class="form-horizontal">
                        ...
                        <table style=" display:block; border: 1px solid #DEDEDE; border-radius:5px; padding:15px;">
                            ...
                            <tr>
                                ...
                                <td align="right" valign="top"></td>
                                <td align="left" valign="top"><h5><asp:Label ID="maxSlideTitleLabel" runat="server" Text=""></asp:Label></h5></td>
                                <td align="right" valign="top"></td>
                                <td align="left"></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td><asp:Image ID="maxSlideSlectImage" alt="" runat="server" width="100px" Visible="false"/></td>
                                <td></td>
                            </tr>
