<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Delete.aspx.cs" Inherits="maxACCOUNT.Admin.web.SLIDES.Delete" %>
		    ...
		    <div class="row-fluid sortable">
			    <div class="box span12">
				    <div class="box-header well" data-original-title>
					    <h2><i class="icon-edit"></i> Maxford Slide - Delete Slide</h2>
				    </div>
					    ...
					    <form class="form-horizontal">
                            ...
                            <table style=" display:block; border: 1px solid #DEDEDE; border-radius:5px; padding:15px;">
                                ...
                                <tr>
                                    <td align="right" valign="top"></td>
                                    <td align="right" valign="top"></td>
                                    <td align="left" valign="top"><h3><asp:Label ID="Label1" runat="server" Text="Are You sure you want to remove existing Slide ?" style="color:Red"></asp:Label></h3></td>
                                    <td align="right" valign="top"></td>
                                    <td align="left"></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td></td>
                                    <td>
                                        <asp:Button ID="maxCropSlideImage" runat="server" Text="DELETE SLIDE"  CssClass="maxButton btn btn-success" Width="100%" OnClick="maxDeleteSlideImage_Click" />
                                        <br />
                                        <br />
                                        <hr />
                                        <br />
					    ...
					    <form class="form-horizontal">
                            ...
                            <table style=" display:block; border: 1px solid #DEDEDE; border-radius:5px; padding:15px;">
                                ...
                                <tr>
                                    <td align="right" valign="top"></td>
                                    <td align="right" valign="top"></td>
                                    <td align="left" valign="top"><h3><asp:Label ID="Label4" runat="server" Text="The existing slide was deleted Successfully." style="color:Green"></asp:Label></h3></td>
                                    <td align="right" valign="top"></td>
                                    <td align="left"></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td></td>
                                    <td>
                                        <asp:Button ID="Button1" runat="server" Text="OK"  CssClass="maxButton btn btn-success" Width="100%" OnClick="maxOkSlideImage_Click" />
                                        <br />
                                        <br />
                                        <hr />
                                        <br />
