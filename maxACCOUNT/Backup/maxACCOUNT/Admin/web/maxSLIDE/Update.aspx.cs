...
namespace MAXFORD.Max_Account.MaxfordUser.Administrator.maxSLIDE
{
    ...
    {  
        ...
        //    string commandString = "SELECT SlideLink,SlideTitle,SlideReadMe,SlideTitleSub,SlideBody,SlideTheamColorOne,SlideTheamColorTwo,SlideDiscripition FROM dbo.MAX_PAGE_Slide WHERE SlideID = '" + SID + "'";
        //    if (SID != null)
        //    {
        //        try
        //        {
        ...
        //            {
        //                maxPictLabel.Text = "<img src='http://www.maxford.lk/Max_Data/Max_Slide/SLIDE/" + dr["SlideLink"].ToString() + "' style='width:100%;' />";
        //                maxSlideTitleTextBox.Text = dr["SlideTitle"].ToString();
        //                maxSlideReadMeTextBox.Text = dr["SlideReadMe"].ToString();
        //                SlideTitleSubTextBox.Text = dr["SlideTitleSub"].ToString();
        //                editor1.InnerHtml = dr["SlideBody"].ToString();

        //                maxSlideTheamColorOne.Text = dr["SlideTheamColorOne"].ToString();
        //                maxSlideTheamColorTwo.Text = dr["SlideTheamColorTwo"].ToString();
        ...
        //                MaxCommand.Parameters.AddWithValue("@SlideTitle", maxSlideTitleTextBox.Text);
