<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="maxACCOUNT.Admin.web.CLASSES.Default" %>
						...
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  ...
						  <tbody>
                            <asp:Repeater ID="Repeater1" runat="server" DataSourceID="BaseSqlDataSource">
                                <ItemTemplate>
							        <tr>
								        ...
								        <td class="center"><%# Eval("ST")%></td>
                                        <td class="center"><%# Eval("ET")%></td>
								        <td class="center"><span class="label label-success"><%# Eval("Activiated")%></span></td>
                                        <td class="center"><%# Eval("ModifiedDate")%></td>
								        <td class="center">
									        <a class="btn btn-success" href='View.aspx?ClassId=<%# Eval("ClassId")%>'>
										        <i class="icon-zoom-in icon-white"></i>  
										        View                                            
									        </a>
									        <a class="btn btn-info" href='Edit.aspx?ClassId=<%# Eval("ClassId")%>'>
										        <i class="icon-edit icon-white"></i>  
										        Edit                                            
									        </a>
									        <a class="btn btn-danger" href='Delete.aspx?ClassId=<%# Eval("ClassId")%>'>
                            ...
                            <asp:SqlDataSource ID="BaseSqlDataSource" runat="server" 
                                ...
                                SelectCommand="SELECT ClassId,ClassName,ClassDate,Activiated,ModifiedDate,CONVERT(varchar(15),ClassStartTime,100) AS 'ST' ,CONVERT(varchar(15),ClassEndTime,100) AS 'ET' FROM [aspnet_Class]">
                            </asp:SqlDataSource>
						  </tbody>
					  </table>            
					</div>
