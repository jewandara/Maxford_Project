<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="maxACCOUNT.Admin.web.USER_ROLE.Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderBodyHead" runat="server">
    ...
    <br />
		<ul class="breadcrumb">
			...
			<li><a href="Default.aspx">USER ROLE</a></li>
		</ul>
	</div>
</asp:Content>
						  ...
						  <tbody>
                            <asp:Repeater ID="Repeater1" runat="server" DataSourceID="BaseSqlDataSource">
                                <ItemTemplate>
							        <tr>
								        <td><%# Eval("RoleName")%></td>
								        <td class="center"><%# Eval("RoleId")%></td>
								        <td class="center"><%# Eval("Description")%></td>
								        <td class="center">
									        <a class="btn btn-success" href='Edit.aspx?RoleID=<%# Eval("RoleId")%>'>
										        <i class="icon-edit icon-white"></i>  
										        Edit                                            
									        </a>
									        <a class="btn btn-danger" href='Delete.aspx?RoleID=<%# Eval("RoleId")%>'>
                            ...
                            <asp:SqlDataSource ID="BaseSqlDataSource" runat="server" 
                                ...
                                SelectCommand="SELECT * FROM dbo.aspnet_Roles">
                            </asp:SqlDataSource>
						  </tbody>
					  </table>
                        <hr />
                        <label class="control-label" for="typeahead">Create A New User Role</label>
                        <asp:HyperLink ID="HyperLinkNewClass" runat="server"  CssClass="btn btn-primary" NavigateUrl="New.aspx">NEW ROLE</asp:HyperLink>
                        <br /><br /><br />
                    </div>
				</div>
			</div>
