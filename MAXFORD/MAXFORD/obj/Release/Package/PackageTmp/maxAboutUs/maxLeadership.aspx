<%@ Page Title="Know About Our Leadership" Language="C#" MasterPageFile="~/maxAboutUs/AboutUs.Master" AutoEventWireup="true" CodeBehind="maxLeadership.aspx.cs" Inherits="MAXFORD.maxAboutUs.maxLeadership" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderRightSideBodyDiscription" runat="server">
    ...
    <img src="images/leadership.png" width="740px"/>
    <br />
