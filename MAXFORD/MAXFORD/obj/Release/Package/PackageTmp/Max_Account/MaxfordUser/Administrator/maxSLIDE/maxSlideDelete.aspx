<%@ Page Title="" Language="C#" MasterPageFile="~/Max_Account/MaxfordUser/User.Master" AutoEventWireup="true" CodeBehind="maxSlideDelete.aspx.cs" Inherits="MAXFORD.Max_Account.MaxfordUser.Administrator.maxSLIDE.maxSlideDelete" %>
    ...
    <asp:Repeater ID="Repeater1" runat="server" 
        ...
        <ItemTemplate>
            <tr Class="maxTRData">
                    ...
                    <td  width="11%"><a href="http://www.maxford.lk/maxSlide/Default.aspx?SlideID=<%# Eval("SlideID") %>"><img class="maxImageLabel" src="<%# Eval("SlideLink") %>" /></a></td>
