<%@ Page Title="" Language="C#" MasterPageFile="~/maxSchedule/Schedule.Master" AutoEventWireup="true" CodeBehind="maxOrdinaryLevel_6_to_9.aspx.cs" Inherits="MAXFORD.maxSchedule.maxOrdinaryLevel_6_to_9" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderMiddleBody" runat="server">
    <img src="images/Ordinary_Level_6_to_9.png"  width="515px"/>
</asp:Content>
