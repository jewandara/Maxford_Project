<%@ Page Title="Update Main Slide" validateRequest="false" Language="C#" MasterPageFile="~/Max_Account/MaxfordUser/User.Master" AutoEventWireup="true" CodeBehind="Update.aspx.cs" Inherits="MAXFORD.Max_Account.MaxfordUser.Administrator.maxSLIDE.Update" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolderBody" runat="server">
     <table cellpadding="6" style="width:100%; text-align:left;">
        ...
        <tr>
            ...
            <td valign="top"><asp:Label ID="maxTheamLabelOne" runat="server" Text=""></asp:Label></td>
        </tr>
        <tr>
            ...
            <td valign="top"><asp:Label ID="maxTheamLabelTwo" runat="server" Text=""></asp:Label></td>
        </tr>
        <tr>
        ...
        <tr>
            <td></td>
            <td></td>
            <td><asp:Button ID="slideInsertButton" runat="server" Text="SUBMIT" 
                    CssClass="maxUserDataButtonStyle" onclick="slideInsertButton_Click" /></td>
            <td></td>
        </tr>
    </table>
