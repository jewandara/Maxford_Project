<%@ Page Title="View Update Main Slide" Language="C#" MasterPageFile="~/Max_Account/MaxfordUser/User.Master" AutoEventWireup="true" CodeBehind="maxSlideUpdate.aspx.cs" Inherits="MAXFORD.Max_Account.MaxfordUser.Administrator.maxSLIDE.maxSlideUpdate" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolderBody" runat="server">
    ...
    <asp:Repeater ID="Repeater1" runat="server" 
        ...
        <ItemTemplate>
            <tr Class="maxTRData">
                    <td  width="11%"><a href="Update.aspx?SlideID=<%# Eval("SlideID") %>"><img class="maxImageLabel" src="<%# Eval("SlideLink") %>" /></a></td>
