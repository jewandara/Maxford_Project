<%@ Page Title="" Language="C#" MasterPageFile="~/Max_Account/MaxfordUser/User.Master" AutoEventWireup="true" CodeBehind="Delete.aspx.cs" Inherits="MAXFORD.Max_Account.MaxfordUser.Administrator.maxSLIDE.Delete" %>
     ...
     <asp:Repeater ID="Repeater1" runat="server" 
        ...
        <ItemTemplate>
            <table  align="center" width="100%">
                <tr align="center">
                    <td><img src="<%# Eval("SlideLink") %>"  width="400px"/></td>
                </tr>
                <tr align="center">
