...
var c=$iTXT.js.exclCont();c.insertBefore(iframe,c.firstChild);},dropScript:function(src,cb,eh,direct)
...
return pos;},getPositionRecursively:function(el){var pos={top:0,left:0};while(el){pos.top+=el.offsetTop;pos.left+=el.offsetLeft
el=el.offsetParent;}
