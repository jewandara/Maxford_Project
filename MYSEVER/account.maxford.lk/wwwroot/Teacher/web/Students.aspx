<%@ Page Title="" Language="C#" MasterPageFile="~/Teacher/Teacher.Master" AutoEventWireup="true" CodeBehind="Students.aspx.cs" Inherits="maxACCOUNT.Teacher.web.Students" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="maxTeacherMenuContentPlaceHolder" runat="server">
    <ul>
        ...
        <li><div class="max_side_menu_bar maxIconSelect maxIconTecherStudents"><a href="Students.aspx">STUDENTS<div class="max_slide_menu_data_number">0</div></a></div></li>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderTeacherBody" runat="server">
    ...
    <asp:Label ID="Label1" runat="server" Text="Student Page is under Construction."></asp:Label>
